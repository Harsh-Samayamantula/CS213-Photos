...
public class SearchController implements LogoutController {
    @FXML
    TextField mandatoryTag1Name, mandatoryTag1Value, mandatoryTag2Name, mandatoryTag2Value, optionalTag1Name,
            optionalTag1Value, beginningDateInput, endDateInput, albumNameInput;
    @FXML
    Button makeAlbum, logout, searchByTagButton, searchByDateButton, backButton;
    @FXML
