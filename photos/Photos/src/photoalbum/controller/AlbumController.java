...
/**
 * The purpose of this class is to allow the logged in user to control/modify
 * thier albums
...
public class AlbumController implements LogoutController {
    @FXML
    Button addPhoto, removePhoto, addCaption, addTag, deleteTag, copy_paste, movePhoto, nextPhoto, previousPhoto,
            logout, changeCaption, search, backbutton;
    @FXML
    TextField taginput, captionInput, valueinput;
    @FXML
    ...
    public class Thumbnail extends ListCell<Photo> {
        ...
        public void updateItem(Photo photoItem, boolean empty) {
            ...
            if (empty || photoItem == null) {
                ...
                // thumbnailImage = new Image(pictureFile.toURI().toString(), 100, 100, false,
                // false);
