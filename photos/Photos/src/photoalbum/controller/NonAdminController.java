...
/**
 * Class allows the user to add, delete, and modify albums. Also lets the user
 * logout and switch to search scene
 */
public class NonAdminController implements LogoutController {

    @FXML
    Button createAlbum, deleteAlbum, renameAlbum, openAlbum, logout, search;
    @FXML
    TextField EnteredAlbumName;
    @FXML
    ListView<String> albumsList;
    @FXML
    Label usertitle;
    /**
    ...
    public void deleteAlbum(ActionEvent e) throws IOException {
        ...
        a.setHeaderText(null);
        a.setContentText(
                "Are you sure you want to delete " + Photos.driver.getCurrentUser().getAlbumAt(index).getAlbumName());
    ...
    public void renameAlbum(ActionEvent e) throws IOException {
        ...
        alert.setHeaderText("Confirm that you would like to change "
                + Photos.driver.getCurrentUser().getAlbums().get(selectionIndex).getAlbumName() + " to "
                + newAlbumName);
    ...
    /**
     * opens selected album by switching scenes to Album.fxml with selected album in
     * view
     * 
     * @param e action event provided by fxml
     * @throws IOException
