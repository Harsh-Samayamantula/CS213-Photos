...
public class User implements Serializable {
    ...
    static Comparator<Album> byEarliestDate = new Comparator<Album>() {
         ...
         * @param arg0 album 1
         * @param arg1 album 2
         * @return int representing the state after comparing the two albums' earliest
         *         photos
         */
        @Override
        public int compare(Album arg0, Album arg1) {
    ...
    /**
     * returns an arraylist of type photo containing search results from a mandatory
     * tag search
     * 
     ...
     * 
     * @return arraylist of type string containing all album names. albums are owned
     *         by the user
     */
